...
def get_dataset(config, type='train', **kwargs):
    ...
    if type == 'train_siamese':
        ...
        # print(data.get_num_scenes()) #17
        # print(data.get_num_tracklets()) #441
        # print(data.get_num_frames_total()) #19522
        # print(data.get_num_frames_tracklet(1)) #8 第1个tracklet有8帧
